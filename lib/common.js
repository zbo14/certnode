...
const PUBLIC_KEY_PERMISSIONS = 0o664
 ...
 * @return {Promise}
 */
const writeKeyToFile = async (dirname, key, passphrase) => {
  ...
  const filename = path.join(dirname, (isPrivateKey ? 'private' : 'public') + 'Key.pem')
